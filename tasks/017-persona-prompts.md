...
- Промпты/шаблоны для **придумывания** персонажей и image gen — задача [039](039-persona-generation-prompts.md)
- Генерация фото персон (offline pipeline в 039 → ассеты в 032)
