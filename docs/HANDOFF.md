...
- Feature branches: `cursor/<descriptive-name>-b139`
- Коммиты с понятными сообщениями, ссылка на task # если есть.
- PR в `main`, после merge — auto-deploy.
...
- Одна задача = один focused PR/commit.
...
> Продолжаем разработку **anonimus_chat**. Прочитай `docs/HANDOFF.md`, `tasks/README.md` и `tasks/MILESTONE-2-full-bot.md`. Следуй всем правилам из HANDOFF. Текущий фокус: [указать задачу, например «E2E smoke на проде» или «задача 036 RunPod»].
